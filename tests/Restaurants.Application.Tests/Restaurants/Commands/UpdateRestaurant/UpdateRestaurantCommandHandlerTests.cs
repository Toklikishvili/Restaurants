...
public class UpdateRestaurantCommandHandlerTests
{
    ...
    public async Task Handle_WithValidRequest_ShouldUpdateRestaurants()
    {
        ...
        _authorizationServiceMock.Setup(m => m.Authorize(restaurant , ResourceOperation.Update))
            .Returns(true);
    ...
    public async Task Handle_WithNonExistingRestaurant_ShouldThrowForbidException()
    {
        ...
        _authorizationServiceMock.Setup(m => m.Authorize(existingRestaurant , ResourceOperation.Update))
            .Returns(false);
